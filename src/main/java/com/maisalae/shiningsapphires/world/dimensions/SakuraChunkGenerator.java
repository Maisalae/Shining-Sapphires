...
public class SakuraChunkGenerator extends NoiseChunkGenerator {
    private final BlockPos spawnPoint;

    public SakuraChunkGenerator(IWorld worldIn, BiomeProvider biomeProviderIn, EndGenerationSettings settingsIn) {
