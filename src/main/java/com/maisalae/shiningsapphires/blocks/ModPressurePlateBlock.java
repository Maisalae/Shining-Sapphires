...
public class ModPressurePlateBlock extends AbstractPressurePlateBlock {
    ...
    private final net.minecraft.block.PressurePlateBlock.Sensitivity sensitivity;

    public ModPressurePlateBlock(net.minecraft.block.PressurePlateBlock.Sensitivity sensitivityIn, Block.Properties propertiesIn) {
        super(propertiesIn);
